...
<%-- <div style="height:8px"></div>
 ...
 <div style="height:8px"></div>
  ...
  <div class="picBox" onclick="switchSysBar()" id="switchPoint" ></div>
    <div class="style3">
        <input id="Button1" style="width:80px" type="button" value="基础信息" />线路：<input type="text" style="width:80px" id="txtInput" name="inputname" onkeydown="ShowSuggest(this,'h6',liststr,strsplit);" />
        </div>
...
线路：&nbsp;
    <div>仅首末站：input id="smz" type="checkbox" checked="checked" />
        </div>
        <div>
            清除查询：<input id="qc" type="checkbox" checked="checked" /><input id="xxys0" 
                style="width:62px;" 
  ...
  function addMarker3(mycars3,lenn)
 {
    ...
    marker.addEventListener("click",function(){
      var opts = {
        ...
        var infocontent="站点名称："+mycars3[2]+"<br/>站台形式："+mycars3[6]+"<br/>站台长度："+mycars3[5]+"<br/>所经车次："+mycars3[4];
