<%@ page language="C#" autoeventwireup="true" inherits="Combination_Route, App_Web_qnz2vcqa" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <p>
                ...
                <p>道路方向：<asp:DropDownList ID="dlfx" runat="server">
                           ...
                           </asp:DropDownList><asp:Button ID="Button3" runat="server" onclick="Button1_Click" Text="搜索" /></p>
                           ...
                           <p>
                               ...
                               <div>
                                       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                           ...
                                           <Columns>
                                               <asp:CommandField HeaderText="操作" SelectText="添加" ShowSelectButton="True">
                               ...
                               <div>************************</div>
                              <div><asp:GridView ID="GridView2" runat="server"  AutoGenerateColumns="False" 
               onselectedindexchanging="GridView2_SelectedIndexChanging">
               <Columns>
                   <asp:CommandField HeaderText="操作" SelectText="删除" ShowSelectButton="True">
                       <ItemStyle HorizontalAlign="Center" />
                   </asp:CommandField>
                   <asp:BoundField DataField="route_master_id" HeaderText="线路">
                       <ItemStyle HorizontalAlign="Center" />
                   </asp:BoundField>
                   <asp:BoundField DataField="sxx" HeaderText="方向">
                       <ItemStyle HorizontalAlign="Center" />
                   </asp:BoundField>
                   <asp:BoundField DataField="id" HeaderText="序号">
                       <ItemStyle HorizontalAlign="Center" />
                   </asp:BoundField>
                   <asp:BoundField DataField="road" HeaderText="道路">
