...
StyleLib.preLoadJson([
{
	id: "S01",
	img: {
		src: "6702.GIF"/*tpa=http://www.bjbus.com/map/js/6702.GIF*/,
		width: 6,
		height: 6,
		pointcoord: "3,3"
	}
...
try{
				...
				{
				case "bus":
					JsClass("http://www.bjbus.com/map/js/modules.bus", function(z)
					{
						z && z("reset") && z.reset();
					});
					break;
	...
	function create()
	{
		...
		div2.onmouseover = function ()
		{
			...
			if (_t._7 && !dok)
			{
				var isMove = false;
				dok = true;
				JsClass("http://www.bjbus.com/map/js/modules.drag", function (fun)
				{
...
var ImageClip = function (url, posLeft, posTop, imgWidth, imgHeight)
	{
		 ...
		 * @example
		 * var imgCp = new ImageClip("a.png"/*tpa=http://www.bjbus.com/map/js/a.png*/,0,0,100,150);
		 * imgCp.setStyle({
		 click:function(){},
		 mouseout:function(){},
		 mouseover:function(){}
